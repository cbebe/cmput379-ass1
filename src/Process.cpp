...
Process
Process::from (std::string const &cmd, InputOptions options)
{
...
void
Process::SetStatus (Status s)
{
  this->status = s;
};

Status
Process::GetStatus () const
{
  return status;
};
