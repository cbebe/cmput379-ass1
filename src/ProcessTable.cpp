...
void
ProcessTable::PrintProcesses () const
{
...
void
ProcessTable::PrintResourcesUsed () const
{
...
void
ProcessTable::NewJob (const std::string &cmd, InputOptions const &options)
{
...
void
ProcessTable::SuspendJob (int pid)
{
  getProcess (pid).Suspend ();
}

void
ProcessTable::WaitJob (int pid)
{
  getProcess (pid).Wait ();
  removeProcess (pid);
}
...
void
ProcessTable::Sleep (int seconds)
{
  Process::Sleep (seconds);
}

void
ProcessTable::ResumeJob (int pid)
{
  getProcess (pid).Resume ();
}

void
ProcessTable::addProcess (Process p)
{
  processes.emplace (p.GetPid (), p);
}

void
ProcessTable::removeProcess (int pid)
{
  processes.erase (pid);
}
